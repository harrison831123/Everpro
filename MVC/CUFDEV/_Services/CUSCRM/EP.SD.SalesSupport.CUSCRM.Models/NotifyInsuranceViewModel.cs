...
{
	public class NotifyInsuranceViewModel : IModel
	{
		/// <summary>
		/// 自動編號
		/// </summary>
		...
		[Column("CHAgentCode")]
		[Display(Name = "處代理人ID")]
		public string CHAgentCode { get; set; }

		/// <summary>
		/// 處代理人實駐姓名職稱
		/// </summary>
		[NonColumn]
		public string CHLvName { get; set; }

		/// <summary>
		/// 招攬人實駐姓名職稱
		/// </summary>
		[NonColumn]
		public string AgLvName { get; set; }

		/// <summary>
		/// VM實駐姓名職稱
		/// </summary>
		[NonColumn]
		public string AgVmLvName { get; set; }

		/// <summary>
		/// SM實駐姓名職稱
		/// </summary>
		[NonColumn]
		public string AgSmLvName { get; set; }

		/// <summary>
		/// 處主管實駐姓名職稱
		/// </summary>
		[NonColumn]
		public string AgCLvName { get; set; }

		/// <summary>
		/// 接續人實駐姓名職稱
		/// </summary>
		[NonColumn]
		public string SuLvName { get; set; }

		/// <summary>
		/// 接續人VM實駐姓名職稱
		/// </summary>
		[NonColumn]
		public string SuVmLvName { get; set; }

		/// <summary>
		/// 接續人SM實駐姓名職稱
		/// </summary>
		[NonColumn]
		public string SuSmLvName { get; set; }

		/// <summary>
		/// 接續人處主管實駐姓名職稱
		/// </summary>
		[NonColumn]
		public string SuCLvName { get; set; }
	}
}
